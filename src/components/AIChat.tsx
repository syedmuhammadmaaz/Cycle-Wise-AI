...
const WELCOME_MESSAGE: ChatMessage = {
  id: 'welcome',
  message: '',
  response: "I am Charlie, your AI health coach here to help with cycle-aware nutrition, training, recovery, and symptom support. Before we dive in, could you please tell me your age, your body type, and your relationship status (single or married)? This helps me give you the most personalized guidance.",
...
const AIChat = ({ onClose }: AIChatProps) => {
  ...
  useEffect(() => {
    ...
    // 1) fetch chat history (includes welcome if no prior messages)
    fetchChatHistory();
